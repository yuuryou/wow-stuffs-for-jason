...
from database import (
    init_db, get_all_videos, get_videos, get_video, add_video, update_video, delete_video,
...
def videos_page():
    ...
    return render_template('videos.html', videos=videos, maps=maps_list,
                          ...
                          current_map=map_filter, search_query=search, lang=lang)
...
def video_detail(video_id):
    ...
    return render_template('video_detail.html', video=video, lang=lang)
